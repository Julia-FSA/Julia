...
export const Terms = () => {
  return (
    <div className="terms-cont">
      <div className="terms-text-cont">
        <h2>
          <strong>Terms and Conditions</strong>
        </h2>

        <p>Welcome to Julia Cooks!</p>

        <p>
          These terms and conditions outline the rules and regulations for the
          use of Julia Cooks's Website, located at
          https://julia-cooks.herokuapp.com.
        </p>

        <p>
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use Julia Cooks if you do not agree to
        ...
        <p>
          We employ the use of cookies. By accessing Julia Cooks, you agreed to
          use cookies in agreement with the Julia Cooks's Privacy Policy.
        </p>
        ...
        <p>
          Unless otherwise stated, Julia Cooks and/or its licensors own the
          intellectual property rights for all material on Julia Cooks. All
          intellectual property rights are reserved. You may access this from
          Julia Cooks for your own personal use subjected to restrictions set in
          these terms and conditions.
        </p>

        <p>You must not:</p>
        <ul>
          <li>Republish material from Julia Cooks</li>
          <li>Sell, rent or sub-license material from Julia Cooks</li>
          <li>Reproduce, duplicate or copy material from Julia Cooks</li>
          <li>Redistribute content from Julia Cooks</li>
        </ul>
        ...
        <p>
          ...
          Julia Cooks does not filter, edit, publish or review Comments prior to
          their presence on the website. Comments do not reflect the views and
          opinions of Julia Cooks,its agents and/or affiliates. Comments reflect
          the views and opinions of the person who post their views and
          opinions. To the extent permitted by applicable laws, Julia Cooks
        ...
        <p>
          Julia Cooks reserves the right to monitor all Comments and to remove
        ...
        <p>
          You hereby grant Julia Cooks a non-exclusive license to use,
        ...
        <p>
          ...
          the hyperlink compensates the absence of Julia Cooks; and (d) the link
        ...
        <p>
          ...
          sending an e-mail to Julia Cooks. Please include your name, your
        ...
        <p>
          No use of Julia Cooks's logo or other artwork will be allowed for
